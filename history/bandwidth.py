...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        print "bandwidth.py returns the average value of bandwidth metrics(net.if.in.bits, net.if.out.bits) over time"
        print "usage: ./bandwith.py [timestampStart] [timestampEnd] [platformName]"
        print "example: ./bandwidth.py  1478700000 1478764076 c01.i01"
        sys.exit(1) 
